...
train_data_path = r'./mydata/trainData4_data.npy'
train_label_path = r'./mydata/trainData4_label.npy'

test_data_path = r'./mydata/testData4_data.npy'
test_label_path = r'./mydata/testData4_label.npy'
